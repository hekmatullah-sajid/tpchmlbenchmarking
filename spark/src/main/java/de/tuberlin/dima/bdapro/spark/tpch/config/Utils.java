...
public class Utils {
	...
	/*
	 * Each query requires one or more substitution parameters that must be generated and used to build the executable query text.
	 * Different lists are defined to be used as a source for generating the substitution parameters.
	 * These random values are used in SQL conditions for defining the intended output.
	 */
	...
	/*
	 * Methods following the comment are used to get a random value from one of
