...
/**
 * <p>
 * The PthaConfig class is used to configure the path to directory where data
 * sets are located. All variables of the class is static.
 * </p>
 * 
...
public class PathConfig {
	...
	/**
	 * Refers to the directory where the data sets are located. PARENT_DIR +
	 * "/tpch2.17.2/dbgen/testdata/" is used as default directory used to store
	 * data sets for JUnit tests.
	 */
	public static final String BASE_DIR = PARENT_DIR + "/tpch2.17.2/dbgen/testdata/";

	/*
	 * The following variables define the name of each data set used in TPCH
	 * queries as input data
	 */
