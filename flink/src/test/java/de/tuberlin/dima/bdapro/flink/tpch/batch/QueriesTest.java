...
/**
 * The class contains the Unit Tests for the 22 queries of TPC-H Benchmark. The
 * TPC-H specification document mentions the sample output for testing output of
 * the queries.
 * 
...
public class QueriesTest {
	...
	public void Query1() {
		...
		final Tuple10<String, String, Double, Double, Double, Double, Double, Double, Double, Long> expected = new Tuple10<String, String, Double, Double, Double, Double, Double, Double, Double, Long>(
				"A", "F", 37734107.00, 56586554400.73, 53758257134.87, 55909065222.83, 25.52, 38273.13, .05,
				(long) 1478493);
	...
	public void Query2() {
		...
		final List<Tuple8<Double, String, String, Integer, String, String, String, String>> result = q2.execute("BRASS",
				15, "EUROPE");

		final Tuple8<Double, String, String, Integer, String, String, String, String> expected = new Tuple8<Double, String, String, Integer, String, String, String, String>(
				9938.53, "Supplier#000005359", "UNITED KINGDOM", 185358, "Manufacturer#4", "QKuHYh,vZGiwu2FWEJoLDx04",
	...
	public void Query3() {
		...
		final List<Tuple4<Integer, Double, String, Integer>> result = q3.execute("BUILDING",
				LocalDate.parse("1995-03-15"));

		final Tuple4<Integer, Double, String, Integer> expected = new Tuple4<Integer, Double, String, Integer>(2456423,
				406181.01, "1995-03-05", 0);
	...
	public void Query7() {
		...
		final List<Tuple4<String, String, Long, Double>> result = q7.execute(Nation.FRANCE.getName(),
				Nation.GERMANY.getName());

		final Tuple4<String, String, Long, Double> expected = new Tuple4<String, String, Long, Double>(
				Nation.FRANCE.getName(), Nation.GERMANY.getName(), (long) 1995, 54639732.73);
	...
	public void Query8() {
		...
		final List<Tuple2<Long, Double>> result = q8.execute(Nation.BRAZIL.getName(), Nation.BRAZIL.getRegion(),
	...
	public void Query9() {
		...
		// value 31342867.24
		final Tuple3<String, Long, Double> expected = new Tuple3<String, Long, Double>(Nation.ALGERIA.getName(),
				(long) 1998, 27136900.18);
	...
	public void Query12() {
		...
		final List<Tuple3<String, Integer, Integer>> result = q12.execute("MAIL", "SHIP",
				LocalDate.parse("1994-01-01"));
	...
	public void Query15() {
		...
		final Tuple5<Integer, String, String, String, Double> expected = new Tuple5<Integer, String, String, String, Double>(
	...
	public void Query16() {
		...
		final List<Tuple4<String, String, Integer, Long>> result = q16.execute("Brand#45", "MEDIUM POLISHED",
				sizeArray);

		final Tuple4<String, String, Integer, Long> expected = new Tuple4<String, String, Integer, Long>("Brand#41",
				"MEDIUM BRUSHED TIN", 3, 28L);
	...
	public void Query18() {
		...
		final Tuple6<String, Integer, Integer, String, Double, Double> expected = new Tuple6<String, Integer, Integer, String, Double, Double>(
	...
	public void Query20() {
		...
		final Tuple2<String, String> expected = new Tuple2<String, String>("Supplier#000000020",
